...
class MealRepository {
  ...
  MealRepository({FirebaseFirestore? firestore}) : firestore = firestore ?? FirebaseFirestore.instance;

  Future<Meal?> getMeal(String mealName) async {
    QuerySnapshot querySnapshot = await firestore.collection("meals").where('Meal Name', isEqualTo: mealName).get();
